...
export const MetadataChartOfAccountsTabularSectionRules = composeMetadataItemRule(
  Tabular.metadataTabularSectionRuleBase, tabularInternalInfo, Tabular.tabularSectionIdentityFragment, Tabular.tabularSectionPresentationFragment, Tabular.tabularSectionFillCheckingFragment, Tabular.tabularSectionStandardAttributesFragment, Tabular.tabularSectionLineNumberFragment, Tabular.tabularSectionAttributesFragment("MetadataChartOfAccountsTabularSectionAttributes"), Tabular.tabularSectionUuidFragment
)

registerOwnerAttributeCollection({ propertyType: "MetadataChartOfAccountsAttributes", schemaName: "MetadataChartOfAccountsAttribute", itemRule: MetadataChartOfAccountsAttributeRules })
registerOwnerAttributeCollection({ propertyType: "MetadataChartOfAccountsTabularSectionAttributes", schemaName: "MetadataChartOfAccountsTabularSectionAttribute", itemRule: MetadataChartOfAccountsTabularSectionAttributeRules })
registerOwnerTabularSectionCollection({ propertyType: "MetadataChartOfAccountsTabularSections", schemaName: "MetadataChartOfAccountsTabularSection", itemRule: MetadataChartOfAccountsTabularSectionRules })
