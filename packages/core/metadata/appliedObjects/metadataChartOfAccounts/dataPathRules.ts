...
import { booleanColumn, metadataRecord, scalarColumn } from "../dataPathCommon/rules"

export const metadataChartOfAccountsDataPathRules: readonly DataPathContribution[] = [{
