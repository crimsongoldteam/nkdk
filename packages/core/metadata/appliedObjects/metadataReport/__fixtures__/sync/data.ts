...
Реквизиты:
  РеквизитВсеСвойства:
    ...
    СвязиПараметровВыбора: Отбор.ЭтоГруппа(Report.ОтчетВсеСвойства.Attribute.РеквизитБулево)
    ПараметрыВыбора:
  ...
  ТабличнаяЧастьВсеСвойства:
    ...
    Реквизиты:
      РеквизитТаблицыВсеСвойства:
        ...
        ПроверкаЗаполнения: ВыдаватьОшибку
        СвязиПараметровВыбора: Отбор.Ссылка(Report.ОтчетВсеСвойства.Attribute.РеквизитВсеСвойства)
        ПараметрыВыбора:
