...
export const exportMetadataCommandToYAML = (
  ...
  if (typeof data.group === "string" && data.group in SE.StandardCommandsGroupToYAML) {
    group = exportSystemEnumerationToYAML<SE.StandardCommandsGroupYAML>(
      context,
  ...
  const representation = exportSystemEnumerationToYAML<SE.ButtonRepresentationYAML>(
    context,
  ...
  const parameterUseMode = exportSystemEnumerationToYAML<SE.CommandParameterUseModeYAML>(
    context,
  ...
  const onMainServerUnavalableBehavior = exportSystemEnumerationToYAML<SE.OnMainServerUnavalableBehaviorYAML>(
    context,
