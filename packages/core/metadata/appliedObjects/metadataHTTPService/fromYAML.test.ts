...
type MetadataHTTPServiceUrlTemplate = NonNullable<typeof full.urlTemplates>[number]
type MetadataHTTPServiceMethod = NonNullable<MetadataHTTPServiceUrlTemplate["methods"]>[number]
