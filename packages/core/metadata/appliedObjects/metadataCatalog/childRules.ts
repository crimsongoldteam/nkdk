...
registerOwnerAttributeCollection({ propertyType: "MetadataCatalogAttributes", schemaName: "MetadataCatalogAttribute", itemRule: MetadataCatalogAttributeRules })
registerOwnerAttributeCollection({ propertyType: "MetadataCatalogTabularSectionAttributes", schemaName: "MetadataCatalogTabularSectionAttribute", itemRule: MetadataCatalogTabularSectionAttributeRules })
registerOwnerTabularSectionCollection({ propertyType: "MetadataCatalogTabularSections", schemaName: "MetadataCatalogTabularSection", itemRule: MetadataCatalogTabularSectionRules })
