...
describe("importUsePurposesFromEnterprise", () => {
  it("should return undefined when data is undefined", () => {
    const result = importUsePurposesFromEnterprise(mockContext, mockRule, undefined)

    expect(result).toBeUndefined()
  })

  it("should import ПлатформаИМобильноеПриложение", () => {
    const result = importUsePurposesFromEnterprise(mockContext, mockRule, "ПлатформаИМобильноеПриложение")

    expect(result).toEqual(["PlatformApplication", "MobilePlatformApplication"])
  })

  it("should import МобильноеПриложение", () => {
    const result = importUsePurposesFromEnterprise(mockContext, mockRule, "МобильноеПриложение")
