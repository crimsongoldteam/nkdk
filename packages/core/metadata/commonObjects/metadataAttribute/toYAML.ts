...
const exportMetadataAttributeToYAML = (
  ...
  const choiceFoldersAndItems = exportSystemEnumerationToYAMLDeprecated<SE.FoldersAndItemsUseYAML>(
    context,
  ...
  const indexing = exportSystemEnumerationToYAMLDeprecated<SE.IndexingYAML>(
    context,
  ...
  const binaryDataStorageLocationUse = exportSystemEnumerationToYAMLDeprecated<SE.BinaryDataStorageLocationUseYAML>(
    context,
