...
import { mockContext, mockRule, mockRule } from "../../../tests/mockContext"
...
describe("importBooleanFromXML", () => {
  it("should return undefined when xml is undefined", () => {
    const result = _importBooleanFromXML(mockContext, mockRule, mockRule, undefined)

    expect(result).toBeUndefined()
  })

  it("should return true when xml is 'true'", () => {
    const result = _importBooleanFromXML(mockContext, mockRule, mockRule, "true")

    expect(result).toBe(true)
  })

  it("should return false when xml is 'false'", () => {
    const result = _importBooleanFromXML(mockContext, mockRule, mockRule, "false")
