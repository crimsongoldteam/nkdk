...
describe("importMetadataValueCollectionFromXML", () => {
  it("should return undefined when data is undefined", () => {
    const result = importMetadataValueCollectionFromXML(mockContext, mockRule, undefined)
  ...
  it("should import with single value", () => {
    ...
    const result = importMetadataValueCollectionFromXML(mockContext, mockRule, xml.BasedOn)
