...
describe("exportCommandBarToXML", () => {
  it("should export all fields to XML", () => {
    ...
    const xmlData = exportElementToXML({ context: mockContextToXML(), element: fullCommandBar })
  ...
  it("should export minimal", () => {
    ...
    const xmlData = exportElementToXML({ context: mockContextToXML(), element: minimalCommandBar })
