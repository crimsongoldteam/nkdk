...
describe("exportPopupToXML", () => {
  it("should return undefined when data is undefined", () => {
    const result = exportPopupToXML(mockContext, undefined)
  ...
  it("should export all fields to XML", () => {
    ...
    const xmlData = exportPopupToXML(mockContext, fullPopup)
  ...
  it("should export minimal", () => {
    ...
    const xmlData = exportPopupToXML(mockContext, minimalPopup)
