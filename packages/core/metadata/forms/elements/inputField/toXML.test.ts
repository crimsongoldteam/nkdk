...
describe("exportInputFieldToXML", () => {
  it("should export all fields to XML", () => {
    ...
    const xmlData = exportElementToXML({ context: mockContextToXML(), element: fullInputField })
  ...
  it("should export minimal", () => {
    ...
    const xmlData = exportElementToXML({ context: mockContextToXML(), element: minimalInputField })
