...
export const InputFieldRules = {
  ...
  properties: {
    ...
    choiceButtonPicture: { yaml: "КартинкаКнопкиВыбора", type: "Picture", metadataTarget: { kind: "commonPicture" } },
    ...
    multipleValuesBackColor: { yaml: "ЦветФонаМножественныхЗначений", type: "Color", metadataTarget: { kind: "styleItem", styleItemTypes: ["Color"] } },
    multipleValuesExtendedEdit: {
      yaml: "РасширенноеРедактированиеМножественныхЗначений",
      type: "boolean",
      xml: "ExtendedEditMultipleValues",
    },
    multipleValuesFont: { yaml: "ШрифтМножественныхЗначений", type: "Font", metadataTarget: { kind: "styleItem", styleItemTypes: ["Font"] } },
    ...
    multipleValuesTextColor: { yaml: "ЦветТекстаМножественныхЗначений", type: "Color", metadataTarget: { kind: "styleItem", styleItemTypes: ["Color"] } },
