...
describe("exportProgressBarFieldToXML", () => {
  it("should export all fields to XML", () => {
    ...
    const xmlData = exportElementToXML({ context: mockContextToXML(), element: fullProgressBarField })
  ...
  it("should export minimal", () => {
    ...
    const xmlData = exportElementToXML({ context: mockContextToXML(), element: minimalProgressBarField })
