...
type GraphicalSchemaFieldCommonFields = Omit<GraphicalSchemaField, "elementType" | "name">

export const exportGraphicalSchemaFieldPartialToEnterprise = <
  From extends GraphicalSchemaField | undefined
>(
  ...
  const output = exportSystemEnumerationToYAML<SE.UseOutputEnterprise>(
    context,
    { type: "SystemEnumeration", typeSE: "UseOutput" },
    data.output
  )
...
const exportGraphicalSchemaFieldCommonFieldsToEnterprise = (
  context: ConfigurationContext,
  _rule: PropertyRule<any>,
  data: GraphicalSchemaFieldCommonFields
): GraphicalSchemaFieldPartialEnterprise => {
  const result: GraphicalSchemaFieldPartialEnterprise = {}
...
registerMetadata(
  ...
  "GraphicalSchemaField",
  exportGraphicalSchemaFieldPartialToEnterprise as ExportPartialToEnterpriseFn
)
