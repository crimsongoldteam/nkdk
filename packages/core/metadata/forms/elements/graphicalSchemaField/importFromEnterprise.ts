...
export function importGraphicalSchemaFieldTypedFromEnterprise<To extends GraphicalSchemaField | undefined>(
  ...
  const props = importGraphicalSchemaFieldPropsFromEnterprise(context, undefined, data)
...
registerMetadata(
  ...
  "GraphicalSchemaField",
  importGraphicalSchemaFieldPartialFromEnterprise as ImportPartialFromEnterpriseFn
)
