...
export function importGeographicalSchemaFieldTypedFromEnterprise<To extends GeographicalSchemaField | undefined>(
  ...
  const props = importGeographicalSchemaFieldPropsFromEnterprise(context, undefined, data)
...
registerMetadata(
  ...
  "GeographicalSchemaField",
  importGeographicalSchemaFieldPartialFromEnterprise as ImportPartialFromEnterpriseFn
)
