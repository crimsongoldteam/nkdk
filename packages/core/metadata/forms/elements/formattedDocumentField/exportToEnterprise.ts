...
registerMetadata(
  ...
  "FormattedDocumentField",
  exportFormattedDocumentFieldPartialToEnterprise as ExportPartialToEnterpriseFn
)
registerMetadata(
  "ExportTypedToEnterprise",
  "FormattedDocumentField",
  exportFormattedDocumentFieldTypedToEnterprise as ExportTypedToEnterpriseFn
)
