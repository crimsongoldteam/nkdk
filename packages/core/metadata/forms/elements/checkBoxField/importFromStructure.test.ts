...
describe("importCheckBoxFieldFromStructure", () => {
  it.each(checkBoxFieldStructureFixturesTable)(
    ...
    ({ element: input, structured: structured }) => {
      const result = importCheckBoxFieldFromStructure(mockContext, structured.strings)
...
const importCheckBoxFieldFromStructure = (mockContext: ConfigurationContext, mock: string[]) => {
