...
export function exportPeriodFieldTypedToEnterprise<From extends PeriodField | undefined>(
  ...
  const props = exportPeriodFieldPropsToEnterprise(context, undefined, data)
...
registerMetadata(
  ...
  "PeriodField",
  exportPeriodFieldPartialToEnterprise as ExportPartialToEnterpriseFn
)
registerMetadata(
  "ExportTypedToEnterprise",
  "PeriodField",
  exportPeriodFieldTypedToEnterprise as ExportTypedToEnterpriseFn
)
