...
export type TrackBarFieldReference = ElementReferenceTypeByRule<typeof TrackBarFieldRules>
...
export interface TrackBarFieldPartialYAML {
  ...
  ОтображениеРазметки?: SE.TrackBarMarkingAppearanceYAML
