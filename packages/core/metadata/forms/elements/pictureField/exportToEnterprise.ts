...
export function exportPictureFieldTypedToEnterprise<From extends PictureField | undefined>(
  ...
  const props = exportPictureFieldPropsToEnterprise(context, undefined, data)
...
const exportPictureFieldPropsToEnterprise = (
  ...
  const valuesPicture = exportPictureToEnterprise(context, undefined, data.valuesPicture)
