...
describe("exportPictureFieldToXML", () => {
  it("should return undefined when data is undefined", () => {
    const result = exportPictureFieldToXML(mockContext, undefined)
  ...
  it("should export all fields to XML", () => {
    ...
    const xmlData = exportPictureFieldToXML(mockContext, fullPictureField)
  ...
  it("should export minimal", () => {
    ...
    const xmlData = exportPictureFieldToXML(mockContext, minimalPictureField)
