...
export function exportGanttChartFieldTypedToEnterprise<From extends GanttChartField | undefined>(
  ...
  const props = exportGanttChartFieldPropsToEnterprise(context, undefined, data)
...
const exportGanttChartFieldPropsToEnterprise = (
  ...
  const tableLocation = exportSystemEnumerationToYAML(
    context,
    undefined,
    data.tableLocation,
  ...
  const valuesSelectionMode = exportSystemEnumerationToYAML(
    context,
    undefined,
  ...
  const intervalsSelectionMode = exportSystemEnumerationToYAML(
    context,
    undefined,
...
registerMetadata(
  ...
  "GanttChartField",
  exportGanttChartFieldTypedToEnterprise as ExportTypedToEnterpriseFn
)
