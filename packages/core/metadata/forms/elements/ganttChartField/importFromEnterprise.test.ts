...
describe("importGanttChartFieldFromEnterprise", () => {
  ...
  it("should import all fields from Enterprise", () => {
    const result = importGanttChartFieldFromEnterprise(mockСontext, fullGanttChartFieldEnterprise, fullGanttChartField.name)
    result!.id = "1"
  ...
  it("should import minimal", () => {
    const result = importGanttChartFieldFromEnterprise(mockСontext, minimalGanttChartFieldEnterprise, minimalGanttChartField.name)
    result!.id = "1"
