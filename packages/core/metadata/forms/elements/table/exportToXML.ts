...
export function exportTableToXML<From extends Table | undefined>(
  ...
  if (data.additionalCreateParameters !== undefined) result.AdditionalCreateParameters = data.additionalCreateParameters
  if (data.allowGettingCurrentRowURL !== undefined) result.AllowGettingCurrentRowURL = data.allowGettingCurrentRowURL
  if (data.allowRootChoice !== undefined) result.AllowRootChoice = data.allowRootChoice
  ...
  if (data.autoRefresh !== undefined) result.AutoRefresh = data.autoRefresh
  if (data.autoRefreshPeriod !== undefined) result.AutoRefreshPeriod = data.autoRefreshPeriod
  ...
  if (data.restoreCurrentRow !== undefined) result.RestoreCurrentRow = data.restoreCurrentRow
  ...
  if (data.showRoot !== undefined) result.ShowRoot = data.showRoot
