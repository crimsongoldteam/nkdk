...
export const TableRules = {
  ...
  properties: {
    ...
    autoInsertNewRow: { yaml: "АвтоВводНовойСтроки", type: "boolean", order: 40 },
    ...
    changeRowOrder: { yaml: "ИзменятьПорядокСтрок", type: "boolean", order: 30 },
    changeRowSet: { yaml: "ИзменятьСоставСтрок", type: "boolean", order: 20 },
    ...
    enableDrag: { yaml: "РазрешитьПеретаскивание", type: "boolean", order: 60 },
    enableStartDrag: { yaml: "РазрешитьНачалоПеретаскивания", type: "boolean", order: 50 },
    ...
    rowsPicture: { yaml: "КартинкаСтрок", type: "Picture", metadataTarget: { kind: "commonPicture" }, order: 90 },
    searchControl: {
