...
describe("exportLabelDecorationToXML", () => {
  it("should return undefined when data is undefined", () => {
    const result = exportLabelDecorationToXML(mockContext, undefined)
  ...
  it("should export all fields to XML", () => {
    ...
    const xmlData = exportLabelDecorationToXML(mockContext, fullLabelDecoration)
  ...
  it("should export minimal", () => {
    ...
    const xmlData = exportLabelDecorationToXML(mockContext, minimalLabelDecoration)
