...
describe("exportExtendedTooltipToXML", () => {
  it("should return default when data is undefined", () => {
    ...
    const xmlData = exportExtendedTooltipToXML(mockContext, undefined, parentElement)
  ...
  it("should return all fields to XML", () => {
    ...
    const xmlData = exportExtendedTooltipToXML(mockContext, fullExtendedTooltip, parentElement)
