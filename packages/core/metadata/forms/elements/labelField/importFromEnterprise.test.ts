...
describe("importLabelFieldFromEnterprise", () => {
  describe("importLabelFieldTypedFromEnterprise", () => {
    ...
    it("should import all fields from Enterprise", () => {
      const result = importLabelFieldTypedFromEnterprise(mockСontext, fullLabelFieldTypedEnterprise, "ПолеНадписи")

      expect(result).toEqual(fullLabelField)
    })

    it("should import minimal", () => {
      const result = importLabelFieldTypedFromEnterprise(mockСontext, minimalLabelFieldTypedEnterprise, "ПолеНадписи")
  ...
  describe("importLabelFieldPartialFromEnterprise", () => {
    ...
    it("should import all fields from Enterprise", () => {
      const result = importLabelFieldPartialFromEnterprise(mockСontext, fullLabelField, fullLabelFieldPartialEnterprise)
