...
describe("exportDendrogramFieldToXML", () => {
  it("should return undefined when data is undefined", () => {
    const result = exportDendrogramFieldToXML(mockСontext, undefined)
  ...
  it("should export all fields to XML", () => {
    ...
    const xmlData = exportDendrogramFieldToXML(mockСontext, fullDendrogramField)
  ...
  it("should export minimal", () => {
    ...
    const xmlData = exportDendrogramFieldToXML(mockСontext, minimalDendrogramField)
