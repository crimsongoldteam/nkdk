...
describe("exportPageToXML", () => {
  it("should return undefined when data is undefined", () => {
    const result = exportPageToXML(mockСontext, undefined)
  ...
  it("should export all fields to XML", () => {
    ...
    const xmlData = exportPageToXML(mockСontext, fullPage)
  ...
  it("should export minimal", () => {
    ...
    const xmlData = exportPageToXML(mockСontext, minimalPage)
