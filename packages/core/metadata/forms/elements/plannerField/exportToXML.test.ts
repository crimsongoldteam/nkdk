...
describe("exportPlannerFieldToXML", () => {
  it("should export all fields to XML", () => {
    ...
    const xmlData = exportElementToXML({ context: mockContext, data: fullPlannerField })
  ...
  it("should export minimal", () => {
    ...
    const xmlData = exportElementToXML({ context: mockContext, data: minimalPlannerField })
