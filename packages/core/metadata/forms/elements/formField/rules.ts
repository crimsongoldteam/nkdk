...
export const formFieldCommonProperties = {
  ...
  footerPicture: { yaml: "КартинкаПодвала", type: "Picture", metadataTarget: { kind: "commonPicture" } },
  ...
  footerTextColor: { yaml: "ЦветТекстаПодвала", type: "Color", metadataTarget: { kind: "styleItem", styleItemTypes: ["Color"] } },
  titleBackColor: { yaml: "ЦветФонаЗаголовка", type: "Color", metadataTarget: { kind: "styleItem", styleItemTypes: ["Color"] } },
  footerBackColor: { yaml: "ЦветФонаПодвала", type: "Color", metadataTarget: { kind: "styleItem", styleItemTypes: ["Color"] } },
  titleFont: { yaml: "ШрифтЗаголовка", type: "Font", metadataTarget: { kind: "styleItem", styleItemTypes: ["Font"] } },
  footerFont: { yaml: "ШрифтПодвала", type: "Font", metadataTarget: { kind: "styleItem", styleItemTypes: ["Font"] } },
  userVisible: {
    yaml: "Использование",
    type: "UserVisible",
    toEnterprise: false,
