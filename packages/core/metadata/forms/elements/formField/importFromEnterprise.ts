...
export const importFormFieldFromEnterprise = (
  ...
  const userVisible = importUserVisibleFromEnterprise(
    context,
    data.ПользовательскаяВидимостьРазрешить || data.ПользовательскаяВидимостьЗапретить,
    data.ПользовательскаяВидимостьРазрешить
      ? "РазрешитьИспользование"
      : data.ПользовательскаяВидимостьЗапретить
