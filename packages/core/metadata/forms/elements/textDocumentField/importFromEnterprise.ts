...
export function importTextDocumentFieldTypedFromEnterprise<To extends TextDocumentField | undefined>(
  ...
  const props = importTextDocumentFieldPropsFromEnterprise(context, undefined, data)
...
registerMetadata(
  ...
  "TextDocumentField",
  importTextDocumentFieldPartialFromEnterprise as ImportPartialFromEnterpriseFn
)
