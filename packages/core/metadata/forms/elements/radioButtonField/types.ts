...
export type RadioButtonFieldReference = ElementReferenceTypeByRule<typeof RadioButtonFieldRules>
...
export interface RadioButtonFieldPartialYAML {
  ВидПереключателя?: SE.RadioButtonTypeYAML
  ВысотаЗаголовкаЭлемента?: number
  ВысотаЭлемента?: number
  КоличествоКолонок?: number
  ОдинаковаяШиринаКолонок?: StringboolYAML
