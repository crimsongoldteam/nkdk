...
export const ElementFixtures: ElementFixture[] = [
  ...
  //#region SearchStringAddition
  {
    ...
    yamlModel: (({ additionSource: _additionSource, ...model }) => model)(fullSearchStringAddition),
  ...
  //#region SearchControlAddition
  {
    ...
    yamlModel: (({ additionSource: _additionSource, ...model }) => model)(fullSearchControlAddition),
