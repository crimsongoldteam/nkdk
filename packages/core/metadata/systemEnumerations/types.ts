...
export type SystemEnumerationTypeMap = {
  DynamicListSearchStringViewMode: DynamicListSearchStringViewMode
  XDTOFacetType: XDTOFacetType
  XMLForm: XMLForm
  WSParameterDirection: WSParameterDirection
  DOMBuilderAction: DOMBuilderAction
  DOMDocumentPosition: DOMDocumentPosition
  DOMNodeFilterParameters: DOMNodeFilterParameters
  DOMNodeType: DOMNodeType
  DOMXPathResultType: DOMXPathResultType
  HTMLContentCategory: HTMLContentCategory
  DataCompositionAccountingBalanceType: DataCompositionAccountingBalanceType
  DataCompositionAreaTemplateType: DataCompositionAreaTemplateType
  DataCompositionAttributesPlacement: DataCompositionAttributesPlacement
  DataCompositionBalanceType: DataCompositionBalanceType
  DataCompositionChartLegendPlacement: DataCompositionChartLegendPlacement
  DataCompositionComparisonType: DataCompositionComparisonType
  DataCompositionConditionalAppearanceUse: DataCompositionConditionalAppearanceUse
  DataCompositionDataSetsLinkType: DataCompositionDataSetsLinkType
  DataCompositionDetailsProcessingAction: DataCompositionDetailsProcessingAction
  DataCompositionFieldPlacement: DataCompositionFieldPlacement
  DataCompositionFieldsTitleType: DataCompositionFieldsTitleType
  DataCompositionFilterApplicationType: DataCompositionFilterApplicationType
  DataCompositionFilterItemsGroupType: DataCompositionFilterItemsGroupType
  DataCompositionFixation: DataCompositionFixation
  DataCompositionGroupFieldsPlacement: DataCompositionGroupFieldsPlacement
  DataCompositionGroupPlacement: DataCompositionGroupPlacement
  ...
  DataCompositionResourcesAutoPosition: DataCompositionResourcesAutoPosition
  DataCompositionResourcesPlacement: DataCompositionResourcesPlacement
  DataCompositionResourcesPlacementInChart: DataCompositionResourcesPlacementInChart
  DataCompositionResultItemType: DataCompositionResultItemType
  DataCompositionResultNestedItemsLayout: DataCompositionResultNestedItemsLayout
  DataCompositionSettingsItemState: DataCompositionSettingsItemState
  DataCompositionSettingsItemViewMode: DataCompositionSettingsItemViewMode
  DataCompositionSettingsRefreshMethod: DataCompositionSettingsRefreshMethod
  DataCompositionSettingsViewMode: DataCompositionSettingsViewMode
  DataCompositionSortDirection: DataCompositionSortDirection
  DataCompositionTextOutputType: DataCompositionTextOutputType
  DataCompositionTextPlacementType: DataCompositionTextPlacementType
  DataCompositionTotalPlacement: DataCompositionTotalPlacement
  ResultCompositionMode: ResultCompositionMode
  SaveDataCompositionAppearance: SaveDataCompositionAppearance
  XSAttributeUseCategory: XSAttributeUseCategory
  XSComplexFinal: XSComplexFinal
  XSComponentType: XSComponentType
  XSCompositor: XSCompositor
  XSConstraint: XSConstraint
  XSContentModel: XSContentModel
  XSDerivationMethod: XSDerivationMethod
  XSDisallowedSubstitutions: XSDisallowedSubstitutions
  XSForm: XSForm
  XSIdentityConstraintCategory: XSIdentityConstraintCategory
  XSNamespaceConstraintCategory: XSNamespaceConstraintCategory
  XSProcessContents: XSProcessContents
  XSProhibitedSubstitutions: XSProhibitedSubstitutions
  XSSchemaFinal: XSSchemaFinal
  XSSimpleFinal: XSSimpleFinal
  XSSimpleTypeVariety: XSSimpleTypeVariety
  XSSubstitutionGroupExclusions: XSSubstitutionGroupExclusions
  XSWhitespaceHandling: XSWhitespaceHandling
  XSXPathVariety: XSXPathVariety
  EventLogDataStorageSplitPeriod: EventLogDataStorageSplitPeriod
  EventLogEntryTransactionMode: EventLogEntryTransactionMode
  EventLogEntryTransactionStatus: EventLogEntryTransactionStatus
  EventLogLevel: EventLogLevel
  DataLockControlMode: DataLockControlMode
  DataLockMode: DataLockMode
  AccountType: AccountType
  AccountingRecordType: AccountingRecordType
  AccumulationRecordType: AccumulationRecordType
  AccumulationRegisterAggregatePeriodicity: AccumulationRegisterAggregatePeriodicity
  AccumulationRegisterAggregateUse: AccumulationRegisterAggregateUse
  AutoTimeMode: AutoTimeMode
  BusinessProcessRoutePointType: BusinessProcessRoutePointType
  CalculationRegisterPeriodType: CalculationRegisterPeriodType
  DocumentPostingMode: DocumentPostingMode
  DocumentWriteMode: DocumentWriteMode
  FoldersAndItemsUse: FoldersAndItemsUse
  PostingModeUse: PostingModeUse
  SliceUse: SliceUse
  BackgroundJobState: BackgroundJobState
  CryptoCertificateCheckMode: CryptoCertificateCheckMode
  CryptoCertificateIncludeMode: CryptoCertificateIncludeMode
  CryptoCertificateStorePlacement: CryptoCertificateStorePlacement
  CryptoCertificateStoreType: CryptoCertificateStoreType
  CryptoInteractiveModeUse: CryptoInteractiveModeUse
  FormattedDocumentFileType: FormattedDocumentFileType
  FormattedDocumentParagraphType: FormattedDocumentParagraphType
  RowGotoDirection: RowGotoDirection
  InternetMailAttachmentEncodingMode: InternetMailAttachmentEncodingMode
  InternetMailMessageImportance: InternetMailMessageImportance
  InternetMailMessageParseStatus: InternetMailMessageParseStatus
  InternetMailProtocol: InternetMailProtocol
  InternetMailTextProcessing: InternetMailTextProcessing
  InternetMailTextType: InternetMailTextType
  SMTPAuthenticationMode: SMTPAuthenticationMode
  UseInternetMailTokenAuthentication: UseInternetMailTokenAuthentication
  QueryBuilderDimensionType: QueryBuilderDimensionType
  AddInConnectionType: AddInConnectionType
  AddInType: AddInType
  ...
  ByteOrderMarkUse: ByteOrderMarkUse
  ClientApplicationBaseFontVariant: ClientApplicationBaseFontVariant
  ...
  CompositeWordsSeparationMode: CompositeWordsSeparationMode
  ConfigurationExtensionScope: ConfigurationExtensionScope
  ConfigurationExtensionsSource: ConfigurationExtensionsSource
  DataBaseConfigurationUpdateState: DataBaseConfigurationUpdateState
  DatabaseTablespacesUseMode: DatabaseTablespacesUseMode
  DateFractions: DateFractions
  DialogReturnCode: DialogReturnCode
  DynamicListKeyType: DynamicListKeyType
  EnterKeyBehaviorType: EnterKeyBehaviorType
  ExternalDataSourceState: ExternalDataSourceState
  FillChecking: FillChecking
  FontType: FontType
  FullTextSearchMetadataUse: FullTextSearchMetadataUse
  FullTextSearchMode: FullTextSearchMode
  FullTextSearchRepresentationType: FullTextSearchRepresentationType
  FullTextSearchVersion: FullTextSearchVersion
  HashFunction: HashFunction
  InterfaceCompatibilityMode: InterfaceCompatibilityMode
  IntervalBoundVariant: IntervalBoundVariant
  Key: Key
  ...
  PeriodSettingsVariant: PeriodSettingsVariant
  PeriodVariant: PeriodVariant
  PictureType: PictureType
  PlatformType: PlatformType
  PredefinedDataUpdate: PredefinedDataUpdate
  QuestionDialogMode: QuestionDialogMode
  ReplacementMode: ReplacementMode
  RoundMode: RoundMode
  SearchDirection: SearchDirection
  SectionsPanelRepresentation: SectionsPanelRepresentation
  SortDirection: SortDirection
  StandardBeginningDateVariant: StandardBeginningDateVariant
  StandardGlobalSearchType: StandardGlobalSearchType
  StandardPeriodVariant: StandardPeriodVariant
  StringEncodingMethod: StringEncodingMethod
  TextEncoding: TextEncoding
  TransactionsIsolationLevel: TransactionsIsolationLevel
  UUIDVersion: UUIDVersion
  UpdateOnDataChange: UpdateOnDataChange
  UserPasswordHashAlgorithmType: UserPasswordHashAlgorithmType
  WorkingDateMode: WorkingDateMode
  XBaseEncoding: XBaseEncoding
  CalendarEventRecurrence: CalendarEventRecurrence
  ContactDataAddressType: ContactDataAddressType
  ContactDataEmailAddressType: ContactDataEmailAddressType
  ContactDataInstantMessagingAddressType: ContactDataInstantMessagingAddressType
  ContactDataPhoneNumberType: ContactDataPhoneNumberType
  ContactDataRelationshipType: ContactDataRelationshipType
  ContactDataURLType: ContactDataURLType
  CallLogCallType: CallLogCallType
  TelephonyToolsCallEventVariant: TelephonyToolsCallEventVariant
  TelephonyToolsSMSType: TelephonyToolsSMSType
  AudioRecordingChannelUse: AudioRecordingChannelUse
  AudioRecordingFormat: AudioRecordingFormat
  BarcodeType: BarcodeType
  CameraLightingType: CameraLightingType
  DeviceCameraType: DeviceCameraType
  DocumentScanningCheckingQuality: DocumentScanningCheckingQuality
  DocumentScanningOrientationDetectionMode: DocumentScanningOrientationDetectionMode
  DocumentScanningProcessingFilter: DocumentScanningProcessingFilter
  MultimediaRecordingStopButtonPlacement: MultimediaRecordingStopButtonPlacement
  VideoQuality: VideoQuality
  QuerySchemaAvailableTableParameterType: QuerySchemaAvailableTableParameterType
  QuerySchemaJoinType: QuerySchemaJoinType
  QuerySchemaOrderDirection: QuerySchemaOrderDirection
  QuerySchemaPeriodAdditionType: QuerySchemaPeriodAdditionType
  QuerySchemaTotalCalculationFieldType: QuerySchemaTotalCalculationFieldType
  QuerySchemaUnionType: QuerySchemaUnionType
  NewPlannerItemsTextType: NewPlannerItemsTextType
  PlannerCommandSource: PlannerCommandSource
  PlannerInsideDragAction: PlannerInsideDragAction
  PlannerInsideDragBoundaryChangeVariant: PlannerInsideDragBoundaryChangeVariant
  PlannerItemActionLocation: PlannerItemActionLocation
  PlannerItemEnableEditMode: PlannerItemEnableEditMode
  PlannerItemsBehaviorOnLackOfSpace: PlannerItemsBehaviorOnLackOfSpace
  PlannerItemsTimeRepresentation: PlannerItemsTimeRepresentation
  PlannerStandardCommand: PlannerStandardCommand
  JSONCharactersEscapeMode: JSONCharactersEscapeMode
  JSONDateFormat: JSONDateFormat
  JSONDateWritingVariant: JSONDateWritingVariant
  JSONLineBreak: JSONLineBreak
  JSONValueType: JSONValueType
  DeliverableNotificationSendErrorType: DeliverableNotificationSendErrorType
  DeliverableNotificationSubscriberType: DeliverableNotificationSubscriberType
  SoundAlert: SoundAlert
  InAppPurchaseService: InAppPurchaseService
  InAppPurchaseType: InAppPurchaseType
  FTPSecureConnectionUsageLevel: FTPSecureConnectionUsageLevel
  InternetConnectionType: InternetConnectionType
  MacOSCertificateSelectMode: MacOSCertificateSelectMode
  OSCertificateSelectMode: OSCertificateSelectMode
  RoamingUsage: RoamingUsage
  ServerTLSCertificateRevocationCheckMode: ServerTLSCertificateRevocationCheckMode
  WindowsCertificateSelectMode: WindowsCertificateSelectMode
  ByteOrder: ByteOrder
  PositionInStream: PositionInStream
  AdBannerRepresentation: AdBannerRepresentation
  AdStatus: AdStatus
  DataLineChangeType: DataLineChangeType
  RepresentableDocumentBatchFileType: RepresentableDocumentBatchFileType
  ClientApplicationAgentState: ClientApplicationAgentState
  DataCompositionDataRelevanceOutputType: DataCompositionDataRelevanceOutputType
  DataCompositionDatabaseCopyOutputType: DataCompositionDatabaseCopyOutputType
  DatabaseCopiesStandardReplicationVersion: DatabaseCopiesStandardReplicationVersion
  DatabaseCopiesUse: DatabaseCopiesUse
  DatabaseCopyContentItemFieldUse: DatabaseCopyContentItemFieldUse
  DatabaseCopyDBMSType: DatabaseCopyDBMSType
  DatabaseCopyReplicationType: DatabaseCopyReplicationType
  DatabaseCopyState: DatabaseCopyState
  DatabaseCopyTurnedOffReason: DatabaseCopyTurnedOffReason
  DatabaseCopyUpdateState: DatabaseCopyUpdateState
  RequiredDataRelevance: RequiredDataRelevance
  CollaborationSystemCommandSource: CollaborationSystemCommandSource
  CollaborationSystemDataDumpStatus: CollaborationSystemDataDumpStatus
  CollaborationSystemStandardCommand: CollaborationSystemStandardCommand
  CollaborationSystemUsersChoicePurpose: CollaborationSystemUsersChoicePurpose
  AdministrationAssignmentRuleType: AdministrationAssignmentRuleType
  AdministrationConnectionSecurityLevel: AdministrationConnectionSecurityLevel
  AdministrationInfoBaseDeletionMode: AdministrationInfoBaseDeletionMode
  AdministrationProcessChoicePriority: AdministrationProcessChoicePriority
  AdministrationWorkProcessStatus: AdministrationWorkProcessStatus
  DuplexPrintingType: DuplexPrintingType
  PageOrientation: PageOrientation
  PagePlacementAlternation: PagePlacementAlternation
  PrintAccuracy: PrintAccuracy
  SpreadsheetDocumentAreaFillType: SpreadsheetDocumentAreaFillType
  SpreadsheetDocumentCellAreaType: SpreadsheetDocumentCellAreaType
  SpreadsheetDocumentCellLineType: SpreadsheetDocumentCellLineType
  SpreadsheetDocumentDetailUse: SpreadsheetDocumentDetailUse
  SpreadsheetDocumentDrawingLineType: SpreadsheetDocumentDrawingLineType
  SpreadsheetDocumentDrawingType: SpreadsheetDocumentDrawingType
  SpreadsheetDocumentFileType: SpreadsheetDocumentFileType
  SpreadsheetDocumentGroupHeaderPlacement: SpreadsheetDocumentGroupHeaderPlacement
  SpreadsheetDocumentPatternType: SpreadsheetDocumentPatternType
  SpreadsheetDocumentPointerType: SpreadsheetDocumentPointerType
  SpreadsheetDocumentSavedPicturesDensity: SpreadsheetDocumentSavedPicturesDensity
  SpreadsheetDocumentSelectionShowModeType: SpreadsheetDocumentSelectionShowModeType
  SpreadsheetDocumentShiftType: SpreadsheetDocumentShiftType
  SpreadsheetDocumentStepDirectionType: SpreadsheetDocumentStepDirectionType
  SpreadsheetDocumentTextPlacementType: SpreadsheetDocumentTextPlacementType
  SpreadsheetDocumentValuesReadingMode: SpreadsheetDocumentValuesReadingMode
  TextPositionRelativeToPicture: TextPositionRelativeToPicture
  UseSpreadsheetDocumentWidthReduction: UseSpreadsheetDocumentWidthReduction
  PivotTableColumnTotalPosition: PivotTableColumnTotalPosition
  PivotTableLinesShowType: PivotTableLinesShowType
  PivotTableRowTotalPosition: PivotTableRowTotalPosition
  QueryRecordType: QueryRecordType
  QueryResultIteration: QueryResultIteration
  AdditionalUserVerificationMethod: AdditionalUserVerificationMethod
  BiometricVerificationMethod: BiometricVerificationMethod
  SecureStorageAccessProtectionMethod: SecureStorageAccessProtectionMethod
  ErrorCategory: ErrorCategory
  ErrorMessageDisplayVariant: ErrorMessageDisplayVariant
  ErrorReportingMode: ErrorReportingMode
  MobileClientSignatureVerificationMethod: MobileClientSignatureVerificationMethod
  OnMainServerUnavalableBehavior: OnMainServerUnavalableBehavior
  UsedServer: UsedServer
  PDFAttachmentRelationshipType: PDFAttachmentRelationshipType
  PDFDocumentFileType: PDFDocumentFileType
  PDFModificationAccessPermissions: PDFModificationAccessPermissions
  PDFSignatureType: PDFSignatureType
  ProgressiveWebApplicationMode: ProgressiveWebApplicationMode
  AdditionalShowMode: AdditionalShowMode
  AppearanceAreaType: AppearanceAreaType
  ...
  AutoShowStateMode: AutoShowStateMode
  AutonumerationInForm: AutonumerationInForm
  ButtonGroupRepresentation: ButtonGroupRepresentation
  ...
  ChildFormItemsWidth: ChildFormItemsWidth
  ChoiceButtonRepresentation: ChoiceButtonRepresentation
  ChoiceHistoryOnInput: ChoiceHistoryOnInput
  ClipboardDataStandardFormat: ClipboardDataStandardFormat
  CollapseFormItemsByImportance: CollapseFormItemsByImportance
  ColorDepth: ColorDepth
  ColumnEditMode: ColumnEditMode
  ColumnLocation: ColumnLocation
  ColumnSizeChange: ColumnSizeChange
  ColumnsGroup: ColumnsGroup
  CommandBarButtonAlignment: CommandBarButtonAlignment
  CommandBarButtonOrder: CommandBarButtonOrder
  CommandBarButtonRepresentation: CommandBarButtonRepresentation
  CommandBarButtonType: CommandBarButtonType
  CommandGroupCategory: CommandGroupCategory
  CommandParameterUseMode: CommandParameterUseMode
  ConnectorLineType: ConnectorLineType
  ConnectorTextLocation: ConnectorTextLocation
  ControlBorderType: ControlBorderType
  ControlCollapseMode: ControlCollapseMode
  ControlEdge: ControlEdge
  CurrentRowUse: CurrentRowUse
  DataChangeType: DataChangeType
  DateSelectionMode: DateSelectionMode
  DimensionAttributePlacementType: DimensionAttributePlacementType
  DimensionPlacementType: DimensionPlacementType
  DisplayImportance: DisplayImportance
  DragAction: DragAction
  DragAllowedActions: DragAllowedActions
  ...
  FormButtonPictureLocation: FormButtonPictureLocation
  FormButtonType: FormButtonType
  FormCommandBarLabelLocation: FormCommandBarLabelLocation
  FormConversationsRepresentation: FormConversationsRepresentation
  FormDecorationType: FormDecorationType
  FormFieldType: FormFieldType
  FormGroupType: FormGroupType
  FormItemAdditionType: FormItemAdditionType
  FormItemCommandBarLabelLocation: FormItemCommandBarLabelLocation
  FormItemOrientation: FormItemOrientation
  FormItemSpacing: FormItemSpacing
  FormItemTitleLocation: FormItemTitleLocation
  FormPagesRepresentation: FormPagesRepresentation
  FormPagesState: FormPagesState
  FormStandardURLVariant: FormStandardURLVariant
  FormWindowOpeningMode: FormWindowOpeningMode
  GraphicalSchemaGridDrawMode: GraphicalSchemaGridDrawMode
  GraphicalSchemaItemPictureLocation: GraphicalSchemaItemPictureLocation
  GraphicalSchemaShapes: GraphicalSchemaShapes
  GraphicalSchemeElementSideType: GraphicalSchemeElementSideType
  HTMLDocumentFieldMode: HTMLDocumentFieldMode
  HorizontalAlign: HorizontalAlign
  IncompleteChoiceMode: IncompleteChoiceMode
  InitialListView: InitialListView
  InitialTreeView: InitialTreeView
  InputFieldAutofillHint: InputFieldAutofillHint
  InputFieldCommandSource: InputFieldCommandSource
  InputFieldMultipleValuePictureShape: InputFieldMultipleValuePictureShape
  InputFieldMultipleValuePictureSize: InputFieldMultipleValuePictureSize
  InputFieldStandardCommand: InputFieldStandardCommand
  ItemHeightControlVariant: ItemHeightControlVariant
  ItemHorizontalLocation: ItemHorizontalLocation
  ItemVerticalAlign: ItemVerticalAlign
  ItemsAndTitlesAlignVariant: ItemsAndTitlesAlignVariant
  LabelPictureLocation: LabelPictureLocation
  LinkedValueChangeMode: LinkedValueChangeMode
  ListEditMode: ListEditMode
  MainClientApplicationWindowMode: MainClientApplicationWindowMode
  NewRowShowCheckVariant: NewRowShowCheckVariant
  OnScreenKeyboardReturnKeyText: OnScreenKeyboardReturnKeyText
  Orientation: Orientation
  PanelPictureLocation: PanelPictureLocation
  PictureFormat: PictureFormat
  PictureSize: PictureSize
  PrintDialogUseMode: PrintDialogUseMode
  ProgressBarSmoothingMode: ProgressBarSmoothingMode
  ...
  ScrollBarUse: ScrollBarUse
  ScrollingTextMode: ScrollingTextMode
  SearchControlLocation: SearchControlLocation
  SearchInTableOnInput: SearchInTableOnInput
  ...
  StandardCommandsGroup: StandardCommandsGroup
  TableBehaviorOnHorizontalCompression: TableBehaviorOnHorizontalCompression
  TableBoxRowInputMode: TableBoxRowInputMode
  TableBoxRowSelectionMode: TableBoxRowSelectionMode
  TableBoxSelectionMode: TableBoxSelectionMode
  TableCurrentRowUse: TableCurrentRowUse
  TableHeightControlVariant: TableHeightControlVariant
  ...
  TimeScalePosition: TimeScalePosition
  TitleLocation: TitleLocation
  ToolTipRepresentation: ToolTipRepresentation
  TrackBarMarkingAppearance: TrackBarMarkingAppearance
  UseMenuMode: UseMenuMode
  UseOutput: UseOutput
  UserNotificationStatus: UserNotificationStatus
  UsualGroupBehavior: UsualGroupBehavior
  UsualGroupControlRepresentation: UsualGroupControlRepresentation
  UsualGroupRepresentation: UsualGroupRepresentation
  VerticalAlign: VerticalAlign
  VerticalFormScroll: VerticalFormScroll
  ...
  WindowAppearanceModeChange: WindowAppearanceModeChange
  WindowAppearanceModeVariant: WindowAppearanceModeVariant
  WindowDockVariant: WindowDockVariant
  WindowLocationVariant: WindowLocationVariant
  WindowSizeChange: WindowSizeChange
  WindowStateVariant: WindowStateVariant
  ...
  ChartBoundaryDetectionMethod: ChartBoundaryDetectionMethod
  ChartBubbleSizeValueSource: ChartBubbleSizeValueSource
  ChartBubbleSizing: ChartBubbleSizing
  ChartColorPalette: ChartColorPalette
  ChartGridLinesShowMode: ChartGridLinesShowMode
  ChartLabelLocation: ChartLabelLocation
  ChartLabelType: ChartLabelType
  ChartLabelsOrientation: ChartLabelsOrientation
  ChartLegendPlacement: ChartLegendPlacement
  ChartLineType: ChartLineType
  ChartMarkerType: ChartMarkerType
  ChartOrientation: ChartOrientation
  ChartPlotAreaPlacement: ChartPlotAreaPlacement
  ChartPointsAxisValuesSource: ChartPointsAxisValuesSource
  ChartPointsConnectionType: ChartPointsConnectionType
  ChartReferenceBandBorderPosition: ChartReferenceBandBorderPosition
  ChartReferenceLinePosition: ChartReferenceLinePosition
  ChartScaleLabelLocation: ChartScaleLabelLocation
  ChartScaleLocation: ChartScaleLocation
  ChartScaleMarkLocation: ChartScaleMarkLocation
  ChartScaleTitlePlacement: ChartScaleTitlePlacement
  ChartScaleTitleTextSource: ChartScaleTitleTextSource
  ChartSelectionMode: ChartSelectionMode
  ChartSemitransparencyMode: ChartSemitransparencyMode
  ChartSeriesGraphicalRepresentationType: ChartSeriesGraphicalRepresentationType
  ChartSeriesOrderInLegend: ChartSeriesOrderInLegend
  ChartSeriesStackType: ChartSeriesStackType
  ChartSpaceMode: ChartSpaceMode
  ChartSplineMode: ChartSplineMode
  ChartTitleAreaPlacement: ChartTitleAreaPlacement
  ChartTrendlineApproximationType: ChartTrendlineApproximationType
  ChartTrendlineFactor: ChartTrendlineFactor
  ChartType: ChartType
  ChartValueEditState: ChartValueEditState
  ChartValuesBySeriesConnectionType: ChartValuesBySeriesConnectionType
  ChartValuesEditMode: ChartValuesEditMode
  ChartValuesToolTipFillType: ChartValuesToolTipFillType
  ChartValuesToolTipShowMode: ChartValuesToolTipShowMode
  ...
  MaxSeries: MaxSeries
  NonnumericChartValueUse: NonnumericChartValueUse
  RadarChartScaleType: RadarChartScaleType
  ShowChartPopupReferenceLine: ShowChartPopupReferenceLine
  ShowChartScaleTitle: ShowChartScaleTitle
  ShowInChart: ShowInChart
  ShowInChartLegend: ShowInChartLegend
  StockChartUsedPointValue: StockChartUsedPointValue
  UsedChartValuesAxis: UsedChartValuesAxis
  GanttChartIntervalRepresentation: GanttChartIntervalRepresentation
  GanttChartIntervalTextRepresentation: GanttChartIntervalTextRepresentation
  GanttChartIntervalsSelectionMode: GanttChartIntervalsSelectionMode
  GanttChartLinkType: GanttChartLinkType
  GanttChartScaleKeeping: GanttChartScaleKeeping
  GanttChartTableLocation: GanttChartTableLocation
  GanttChartTextPlacementType: GanttChartTextPlacementType
  GanttChartValueTextRepresentation: GanttChartValueTextRepresentation
  GanttChartValuesSelectionMode: GanttChartValuesSelectionMode
  GanttChartVerticalStretch: GanttChartVerticalStretch
  ShowInGanttChart: ShowInGanttChart
  TimeScaleDayFormat: TimeScaleDayFormat
  TimeScaleUnitType: TimeScaleUnitType
  PivotChartLabelsOrientation: PivotChartLabelsOrientation
  PivotChartScaleKeeping: PivotChartScaleKeeping
  PivotChartType: PivotChartType
  PivotChartValuesShowMode: PivotChartValuesShowMode
  DendrogramOrientation: DendrogramOrientation
  DendrogramScaleKeeping: DendrogramScaleKeeping
  GeographicalSchemaLayerSeriesImportModeType: GeographicalSchemaLayerSeriesImportModeType
  GeographicalSchemaLayerSeriesShowMode: GeographicalSchemaLayerSeriesShowMode
  GeographicalSchemaLegendItemShowScaleType: GeographicalSchemaLegendItemShowScaleType
  GeographicalSchemaLineType: GeographicalSchemaLineType
  GeographicalSchemaMarkerType: GeographicalSchemaMarkerType
  GeographicalSchemaObjectFindType: GeographicalSchemaObjectFindType
  GeographicalSchemaPointObjectDrawingType: GeographicalSchemaPointObjectDrawingType
  GeographicalSchemaProjection: GeographicalSchemaProjection
  GeographicalSchemaShowMode: GeographicalSchemaShowMode
  PaintingReferencePointPosition: PaintingReferencePointPosition
  SeriesValuesDrawingMode: SeriesValuesDrawingMode
  IntegrationServiceChannelState: IntegrationServiceChannelState
  ArchiveFileCompressionLevel: ArchiveFileCompressionLevel
  ArchiveFileCompressionMethod: ArchiveFileCompressionMethod
  ArchiveFileEncryptionMethod: ArchiveFileEncryptionMethod
  ArchiveFileRestoreFilePathsMode: ArchiveFileRestoreFilePathsMode
  ArchiveFileStorePathMode: ArchiveFileStorePathMode
  ArchiveFileSubDirProcessingMode: ArchiveFileSubDirProcessingMode
  ArchiveFileType: ArchiveFileType
  FileNamesEncodingInArchiveFile: FileNamesEncodingInArchiveFile
  FileAccess: FileAccess
  FileCompareMethod: FileCompareMethod
  FileDialogMode: FileDialogMode
  FileDialogSection: FileDialogSection
  FileDragMode: FileDragMode
  FileOpenMode: FileOpenMode
  GetFilesArchiveMode: GetFilesArchiveMode
  IncomingShareRequestStandardCommand: IncomingShareRequestStandardCommand
  MobileDeviceLibraryDirType: MobileDeviceLibraryDirType
  ShareRequestDataProcessingVariant: ShareRequestDataProcessingVariant
  AccountMainPresentation: AccountMainPresentation
  AccumulationRegisterType: AccumulationRegisterType
  AttributeUse: AttributeUse
  BinaryDataBlockStorageUseMode: BinaryDataBlockStorageUseMode
  BinaryDataStorageMode: BinaryDataStorageMode
  BusinessProcessNumberPeriodicity: BusinessProcessNumberPeriodicity
  BusinessProcessNumberType: BusinessProcessNumberType
  CalculationRegisterPeriodicity: CalculationRegisterPeriodicity
  CalculationTypeMainPresentation: CalculationTypeMainPresentation
  CatalogCodeType: CatalogCodeType
  CatalogCodesSeries: CatalogCodesSeries
  CatalogMainPresentation: CatalogMainPresentation
  CharOfAccountCodeSeries: CharOfAccountCodeSeries
  CharacteristicKindCodesSeries: CharacteristicKindCodesSeries
  CharacteristicTypeMainPresentation: CharacteristicTypeMainPresentation
  ChartOfCalculationTypesBaseUse: ChartOfCalculationTypesBaseUse
  ChartOfCalculationTypesCodeType: ChartOfCalculationTypesCodeType
  ChoiceDataGetModeOnInputByString: ChoiceDataGetModeOnInputByString
  ChoiceMode: ChoiceMode
  CommonAttributeAuthenticationSeparation: CommonAttributeAuthenticationSeparation
  CommonAttributeAutoUse: CommonAttributeAutoUse
  CommonAttributeDataSeparation: CommonAttributeDataSeparation
  CommonAttributeSeparatedDataUse: CommonAttributeSeparatedDataUse
  CommonAttributeUse: CommonAttributeUse
  CommonAttributeUsersSeparation: CommonAttributeUsersSeparation
  CompatibilityMode: CompatibilityMode
  ConfigurationExtensionPurpose: ConfigurationExtensionPurpose
  CreateOnInput: CreateOnInput
  DataExchangeMainPresentation: DataExchangeMainPresentation
  DataHistoryUse: DataHistoryUse
  DefaultDataLockControlMode: DefaultDataLockControlMode
  DocumentNumberPeriodicity: DocumentNumberPeriodicity
  DocumentNumberType: DocumentNumberType
  EditType: EditType
  ExternalDataSourceTableDataType: ExternalDataSourceTableDataType
  ExternalDataSourceTableType: ExternalDataSourceTableType
  FormType: FormType
  ...
  IntegrationServiceChannelMessageDirection: IntegrationServiceChannelMessageDirection
  ...
  RegisterWriteMode: RegisterWriteMode
  ...
  SessionReuseMode: SessionReuseMode
  StyleElementType: StyleElementType
  SubordinationUse: SubordinationUse
  SynchronousExtensionAndAddInCallUseMode: SynchronousExtensionAndAddInCallUseMode
  TaskMainPresentation: TaskMainPresentation
  TaskNumberAutoPrefix: TaskNumberAutoPrefix
  TaskNumberType: TaskNumberType
  TemplateType: TemplateType
  TransferDirection: TransferDirection
  TypeReductionMode: TypeReductionMode
  UseFullTextSearch: UseFullTextSearch
  UseQuickChoice: UseQuickChoice
  PresentationAdditionType: PresentationAdditionType
  ReportBuilderDetailsFillType: ReportBuilderDetailsFillType
  ReportBuilderDimensionType: ReportBuilderDimensionType
  TotalPlacementType: TotalPlacementType
  XMLAttributeType: XMLAttributeType
  XMLCanonicalizationType: XMLCanonicalizationType
  XMLNodeType: XMLNodeType
  XMLSpace: XMLSpace
  XMLTypeAssignment: XMLTypeAssignment
  XMLValidationType: XMLValidationType
  AllowedMessageNo: AllowedMessageNo
  AutoChangeRecord: AutoChangeRecord
  DataItemReceive: DataItemReceive
  DataItemSend: DataItemSend
  AnalysisDataType: AnalysisDataType
  AssociationRulesDataSourceType: AssociationRulesDataSourceType
  AssociationRulesPruneType: AssociationRulesPruneType
  ClusterizationMethod: ClusterizationMethod
  DataAnalysisAssociationRulesOrderType: DataAnalysisAssociationRulesOrderType
  DataAnalysisColumnTypeAssociationRules: DataAnalysisColumnTypeAssociationRules
  DataAnalysisColumnTypeClusterization: DataAnalysisColumnTypeClusterization
  DataAnalysisColumnTypeDecisionTree: DataAnalysisColumnTypeDecisionTree
  DataAnalysisColumnTypeSequentialPatterns: DataAnalysisColumnTypeSequentialPatterns
  DataAnalysisColumnTypeSummaryStatistics: DataAnalysisColumnTypeSummaryStatistics
  DataAnalysisDistanceMetricType: DataAnalysisDistanceMetricType
  DataAnalysisFieldType: DataAnalysisFieldType
  DataAnalysisNumericValueUseType: DataAnalysisNumericValueUseType
  DataAnalysisResultTableFillType: DataAnalysisResultTableFillType
  DataAnalysisSequentialPatternsOrderType: DataAnalysisSequentialPatternsOrderType
  DataAnalysisStandardizationType: DataAnalysisStandardizationType
  DataAnalysisTimeIntervalUnitType: DataAnalysisTimeIntervalUnitType
  DecisionTreeSimplificationType: DecisionTreeSimplificationType
  PredictionModelColumnType: PredictionModelColumnType
  FileNamesEncodingInZipFile: FileNamesEncodingInZipFile
  ZIPCompressionLevel: ZIPCompressionLevel
  ZIPCompressionMethod: ZIPCompressionMethod
  ZIPEncryptionMethod: ZIPEncryptionMethod
  ZIPRestoreFilePathsMode: ZIPRestoreFilePathsMode
  ZIPStorePathMode: ZIPStorePathMode
  ZIPSubDirProcessingMode: ZIPSubDirProcessingMode
  Chars: Chars
  PictureLib: PictureLib
  StyleBorders: StyleBorders
