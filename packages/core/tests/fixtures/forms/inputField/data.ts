...
export const fullInputField: RequiredFieldsElement<InputField> = {
  ...
  minValue: 0,
  multiLine: true,
  multipleValuePictureDataPath: "РеквизитКартинкаМножественногоЗначения",
  multipleValuePictureShape: "Circle",
  multipleValuePictureSize: "Large",
  multipleValuePresentationDataPath: "РеквизитПредставленияМножественногоЗначения",
  ...
  multipleValueValueDataPath: "РеквизитЗначенияМножественногоЗначения",
