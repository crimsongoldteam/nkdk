...
// 1 одиночный элемент с генерацией имени (расширенная подсказка, контекстное меню, etc) - имя не нужно, тип не нужен
...
// 3 свойства полей присутствующих в схеме (группы, поля ввода, флажки, картинки, декорации) - имя не нужно
