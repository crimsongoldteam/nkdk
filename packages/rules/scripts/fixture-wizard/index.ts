...
const usage =
  "Использование: pnpm --filter @nkdk/rules exec tsx scripts/fixture-wizard/index.ts <metadataItem> <dumpRoot>\n" +
  "Пример: pnpm --filter @nkdk/rules exec tsx scripts/fixture-wizard/index.ts metadataCatalog /Users/nikita/git/roundTripElements"
...
function resolveProjectRoot(): string {
  ...
  if (cwd.endsWith("packages/rules")) {
    return resolve(cwd, "../..")
  }
