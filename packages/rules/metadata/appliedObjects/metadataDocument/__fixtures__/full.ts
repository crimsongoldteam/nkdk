...
export const fullYAML: MetadataDocumentYAML = {
  ...
  ВводПоСтроке: ["СтандартныйРеквизит.Номер", "Реквизит.ИндексированноеПоле"],
  ...
  ПоляБлокировкиДанных: ["СтандартныйРеквизит.Номер", "СтандартныйРеквизит.Дата"],
  Пояснение: "Пояснение\n",
  ...
  Характеристики: [
    {
      ...
      ПолеВида: "Справочник.СправочникПолный.Реквизит.Реквизит1",
      ПолеКлюча: "ПланВидовХарактеристик.ХарактеристикиОбъектов.СтандартныйРеквизит.Ссылка",
      ПолеОбъекта: "Справочник.СправочникПолный.Реквизит.Реквизит1",
