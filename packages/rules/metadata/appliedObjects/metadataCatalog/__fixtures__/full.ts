...
export const fullYAML: MetadataCatalogYAML = {
  Автонумерация: "Ложь",
  БыстрыйВыбор: "Истина",
  ВводПоСтроке: ["СтандартныйРеквизит.Наименование", "СтандартныйРеквизит.Код", "Реквизит.СтроковыйРеквизитСИндексом"],
  ...
  ОсновнаяФормаГруппы: "ФормаГруппы",
  ОсновнаяФормаДляВыбора: "ФормаВыбора",
  ОсновнаяФормаДляВыбораГруппы: "ФормаВыбораГруппы",
  ...
  ПоляБлокировкиДанных: ["СтандартныйРеквизит.Наименование", "СтандартныйРеквизит.Код"],
  Пояснение: "Пояснение",
  ...
  СтандартныеРеквизиты: {
    Владелец: {
      ...
      Синоним: "Синоним",
      СозданиеПриВводе: "НеИспользовать",
      ФормаВыбора: "Справочник.СправочникВладелец.Форма.ФормаВыбора",
    },
    Родитель: {
