...
describe("compressMetadataFieldPath", () => {
  ...
  it("реквизит вложен в табличную часть", () => {
    expect(compressMetadataFieldPath("Справочник.X.ТабличнаяЧасть.Z.Реквизит.W")).toBe("Справочник.X.Z.W")
  })

  it("стандартный реквизит в табличной части", () => {
    expect(compressMetadataFieldPath("Справочник.X.ТабличнаяЧасть.Z.СтандартныйРеквизит.НомерСтроки")).toBe(
      "Справочник.X.Z.НомерСтроки"
    )
  })
