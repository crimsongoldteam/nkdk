...
- [src/nkdk.langium](src/nkdk.langium) -  The grammar definition of your language
- [src/nkdk-module.ts](src/nkdk-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/nkdk-validator.ts](src/nkdk-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/nkdk.monarch.ts](src/syntaxes/nkdk.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/nkdk.tmLanguage.json](syntaxes/nkdk.tmLanguage.json) - Textmate based syntax highlighting instructions.
