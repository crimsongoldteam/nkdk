...
export const guideDefinitions: GuideDefinition[] = [
  ...
  },
  {
    ...
    text: [
      ...
      "`nkdk.import_from_xml` не очищает Проект: при импорте в непустой каталог могут сохраниться файлы объектов и ресурсов, удалённых из XML-выгрузки.",
      "При неуспешной операции временные файлы сохраняются в `.nkdk/tmp/import/<operation-id>`; путь возвращается в `preservedTempRoot`.",
      "В этой версии import не подключается к 1С: входом служит готовый каталог XML-выгрузки.",
