...
соответствующей текущей формы `cf`.
...
Обновить ожидаемое число успешно импортированных назначений с `7` на `8`. Существующие проверки отсутствия восстановимой основы для `ФормаРавнаяОснова` и сохранения значимой основы для `ФормаОтчета` оставить без изменения.
