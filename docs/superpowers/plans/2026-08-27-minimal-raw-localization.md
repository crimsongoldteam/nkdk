...
- [x] **Step 1: Написать падающие тесты атомарных различий**
...
- [x] **Step 2: Запустить тест и подтвердить падение из-за отсутствующего API**

  Run: `pnpm --filter @nkdk/runtime test -- --run xml/structure/compare.test.ts`

- [x] **Step 3: Выделить единый обход сравнения**
...
- [x] **Step 4: Запустить целевой тест и проверку дубликатов**
