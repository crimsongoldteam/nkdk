...
- [x] **Step 1: Написать проверку заимствованных операций**
...
- [x] **Step 3: Построить заимствованное состояние по существующей фикстуре**
...
- [x] **Step 4: Добавить собственные расширения заимствованного владельца**
...
- [x] **Step 5: Добавить оба удаления и контроль основной конфигурации**
...
- [x] **Step 6: Запустить тесты и зафиксировать изменение**
