...
- [ ] **Step 1: Описать ожидаемые операции формы и макета тестом**
...
- [ ] **Step 3: Разделить создание формы и изменения содержимого**
...
- [ ] **Step 4: Добавить текстовые макеты**
...
- [ ] **Step 5: Запустить тесты, проверить дубли и зафиксировать**
...
- [ ] **Step 1: Написать проверку собственного жизненного цикла**
...
- [ ] **Step 3: Объявить изменения корня расширения**
...
- [ ] **Step 4: Создать декларации собственных объектов**
...
- [ ] **Step 6: Запустить тесты, проверить дубли и зафиксировать**
...
Expected: все блоки возвращают `synchronized -> unchanged`, проверка
восстановления повторяет выбранный блок, итоговые `cf` и
`cfe/Расширение_All` совпадают. Сохранить из `logs/timings.json` общее время,
...
массив после дефекта, если достаточно продолжить с последней контрольной копии.
