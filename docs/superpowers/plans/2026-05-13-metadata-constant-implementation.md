...
export const MetadataConstantRules = {
  ...
  properties: {
    ...
    passwordMode: { yaml: "РежимПароля", type: "boolean", defaultValueXML: false, defaultValueYAML: false, xmlParents: ["Properties"] },
    ...
    markNegatives: { yaml: "ВыделятьОтрицательные", type: "boolean", defaultValueXML: false, defaultValueYAML: false, xmlParents: ["Properties"] },
    mask: { yaml: "Маска", type: "string", xmlParents: ["Properties"], defaultValueXMLRaw: "" },
    multiLine: { yaml: "МногострочныйРежим", type: "boolean", defaultValueXML: false, defaultValueYAML: false, xmlParents: ["Properties"] },
    extendedEdit: { yaml: "РасширенноеРедактирование", type: "boolean", defaultValueXML: false, defaultValueYAML: false, xmlParents: ["Properties"] },
    ...
    fillChecking: { yaml: "ПроверкаЗаполнения", type: "SystemEnumeration", typeSE: "FillChecking", defaultValueXML: "DontCheck", defaultValueYAML: "DontCheck", xmlParents: ["Properties"] },
    choiceFoldersAndItems: { yaml: "ВыборГруппИЭлементов", type: "SystemEnumeration", typeSE: "FoldersAndItemsUse", defaultValueXML: "Items", defaultValueYAML: "Items", xmlParents: ["Properties"] },
    ...
    quickChoice: { yaml: "БыстрыйВыбор", type: "SystemEnumeration", typeSE: "UseQuickChoice", defaultValueXML: "Auto", defaultValueYAML: "Auto", xmlParents: ["Properties"] },
