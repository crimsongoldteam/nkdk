...
- [ ] **Step 1: Усилить E2E-проверку импортированного YAML**
...
- [ ] **Step 2: Запустить metadata E2E и подтвердить отсутствие старых 13 диагностик**
...
- [ ] **Step 4: Зафиксировать фактические команды и результаты в плане**
