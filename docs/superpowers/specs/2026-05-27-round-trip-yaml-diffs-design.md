...
- `6`: `CommonCommands/АвтономнаяРабота.xml`
- `7`: `CommonCommands/АвтономнаяРабота/Ext/CommandModule.bsl`
- `8`: `CommonCommands/АвтономнаяРаботаВМоделиСервиса.xml`
- `9`: `CommonCommands/АвтономнаяРаботаВМоделиСервиса/Ext/CommandModule.bsl`
- `10`: `CommonCommands/АмортизацияИИзносОС.xml`
