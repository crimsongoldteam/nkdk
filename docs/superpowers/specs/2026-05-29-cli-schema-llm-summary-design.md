...
Все LLM-срезы возвращают одну структуру верхнего уровня: `fields`.
...
- приведение всех LLM-режимов к единой структуре `fields`.
...
- все LLM-режимы возвращают верхний ключ `fields`.
