...
5. Для каждого свойства найди соответствующий тип в `PropertyTypeRegistry` (`packages/core/metadata/ruleRuntime/property/registry.ts`). Если тип не найден, спроси у пользователя что делать.
