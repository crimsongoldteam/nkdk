...
Формат — строго по `.agents/skills/grill-me/SKILL.md`: **по одному вопросу**, с **предлагаемым ответом** и **обоснованием**. Агент не переходит к следующему, пока не получил ответ.
