...
- Внешние XML-файлы из `Ext/*`, которые должны сохраняться без разбора, считай непрозрачным источником:
  копируй их через внешний sync-механизм и не выводи из них модельные свойства без отдельного решения.
...
- Каталог справки `hlp/1/FileStorage/objects` даёт русские имена свойств, типы платформы и описания.
- Русские имена из справки являются главным кандидатом на YAML-ключи.
- Если каталог справки недоступен для глубокого исследования нового прикладного объекта, останови исследование и попроси настроить локальные ресурсы.
...
3. Справка 1С — русские свойства и платформенные типы.
