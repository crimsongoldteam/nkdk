...
export const importDocumentFromXML = (xml: DocumentXML | undefined): Document | undefined => {
  if (!xml) return undefined
   
  return {
elementType: FormElementType.Document,
...
registerImport(FormElementType.Document, importDocumentFromXML)