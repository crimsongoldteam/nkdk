...
export const importObjectFromXML = (xml: ObjectXML | undefined): Object | undefined => {
  if (!xml) return undefined
   
  return {
elementType: FormElementType.Object,
...
registerImport(FormElementType.Object, importObjectFromXML)