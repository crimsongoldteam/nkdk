...
export const ZButtonRules: TElementRules = {
  "autoMaxHeight": {
  ...
  "locationInCommandBar": {
    ...
    nameXML: "LocationInCommandBar",
    get typeXML() { return SE.ZButtonLocationInCommandBar },
  ...
  "pictureLocation": {
    ...
    nameXML: "PictureLocation",
    get typeXML() { return SE.ZFormButtonPictureLocation },
  ...
  "type": {
    ...
    nameXML: "Type",
    get typeXML() { return SE.ZFormButtonType },
    nameEnterprise: "Вид",
    format: undefined,
    isProperties: ()=> true,
  },
