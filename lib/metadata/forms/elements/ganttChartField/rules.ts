...
const rules: TElementRules = {
  ...
  intervalsSelectionMode: {
    get type() {
      return SE.ZGanttChartIntervalsSelectionMode
    },
    nameEnterprise: "РежимВыделенияИнтервалов",
    formatProperties: formatSystemEnumeration,
    get typeEnterprise() {
      return SE.ZGanttChartIntervalsSelectionModeEnterprise
    },
    inProperties: () => true,
  },
  maxHeight: {
  ...
  tableLocation: {
    get type() {
      return SE.ZGanttChartTableLocation
    },
    nameEnterprise: "ПоложениеТаблицы",
    formatProperties: formatSystemEnumeration,
    get typeEnterprise() {
      return SE.ZGanttChartTableLocationEnterprise
    },
    inProperties: () => true,
  },
  valuesSelectionMode: {
    get type() {
      return SE.ZGanttChartValuesSelectionMode
    },
    nameEnterprise: "РежимВыделенияЗначений",
    formatProperties: formatSystemEnumeration,
    get typeEnterprise() {
      return SE.ZGanttChartValuesSelectionModeEnterprise
    },
    inProperties: () => true,
  },
  verticalLines: {
