...
const rules: TElementRules = {
  ...
  "dimensionItemHyperlink": {
    get type() { return z.boolean() },
    nameEnterprise: "ГиперссылкаЭлементаИзмерения",
    formatProperties: formatBoolean,
    inProperties: ()=> true,
  },
  "enableDrag": {
  ...
  "timeScaleItemHyperlink": {
    get type() { return z.boolean() },
    nameEnterprise: "ГиперссылкаЭлементаШкалыВремени",
    formatProperties: formatBoolean,
    inProperties: ()=> true,
  },
  "verticalStretch": {
  ...
  "wrappedTimeScaleHeaderHyperlink": {
    get type() { return z.boolean() },
    nameEnterprise: "ГиперссылкаПеренесенногоЗаголовкаШкалыВремени",
    formatProperties: formatBoolean,
    inProperties: ()=> true,
  },
}

registerElementRules(ZElementType.enum.PlannerField, rules)