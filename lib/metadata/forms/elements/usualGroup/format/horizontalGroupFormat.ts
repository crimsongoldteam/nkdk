...
export const formatHorizontalGroup = (element: UsualGroup, configurationSettings: Context): IFormatElementResult => {
...
const getVerticalItems = (element: UsualGroup, configurationSettings: Context): string[][] => {
  let result: string[][] = []
