...
export const ZPopupRules: TElementRules = {
  "enableContentChange": {
  ...
  "representation": {
    ...
    get typeXML() { return SE.ZButtonRepresentation },
  ...
  "shape": {
    ...
    nameXML: "Shape",
    get typeXML() { return SE.ZButtonShape },
  ...
  "shapeRepresentation": {
    ...
    nameXML: "ShapeRepresentation",
    get typeXML() { return SE.ZButtonShapeRepresentation },
