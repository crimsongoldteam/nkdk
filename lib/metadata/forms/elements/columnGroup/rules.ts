...
export const ZColumnGroupRules: TElementRules = {
  "enableContentChange": {
  ...
  "group": {
    get type() { return SE.ZColumnsGroup },
    nameXML: "Group",
    get typeXML() { return SE.ZColumnsGroup },
