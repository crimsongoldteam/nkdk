...
const rules: TElementRules = {
  ...
  "checkBoxType": {
    get type() { return SE.ZCheckBoxType },
    nameEnterprise: "ВидФлажка",
    formatProperties: formatSystemEnumeration,
    get typeEnterprise() { return SE.ZCheckBoxTypeEnterprise },
    inProperties: ()=> true,
  },
  "editFormat": {
    get type() { return ZI8nText },
  ...
  "equalItemsWidth": {
    get type() { return z.boolean() },
    nameEnterprise: "ОдинаковаяШиринаЭлементов",
    formatProperties: formatBoolean,
    inProperties: ()=> true,
  },
  "font": {
  ...
  "threeState": {
    get type() { return z.boolean() },
    nameEnterprise: "ТриСостояния",
    formatProperties: formatBoolean,
    inProperties: ()=> true,
  },
}

registerElementRules(ZElementType.enum.CheckBoxField, rules)