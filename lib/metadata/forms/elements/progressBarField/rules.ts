...
const rules: TElementRules = {
  ...
  "orientation": {
    get type() { return SE.ZFormItemOrientation },
    nameEnterprise: "Ориентация",
    formatProperties: formatSystemEnumeration,
    get typeEnterprise() { return SE.ZFormItemOrientationEnterprise },
    inProperties: ()=> true,
  },
  "representation": {
    get type() { return SE.ZProgressBarSmoothingMode },
    nameEnterprise: "Отображение",
    formatProperties: formatSystemEnumeration,
    get typeEnterprise() { return SE.ZProgressBarSmoothingModeEnterprise },
    inProperties: ()=> true,
  },
  "showPercent": {
    get type() { return z.boolean() },
    nameEnterprise: "ОтображатьПроценты",
    formatProperties: formatBoolean,
    inProperties: ()=> true,
  },
  "verticalStretch": {
...
registerElementRules(ZElementType.enum.ProgressBarField, rules)