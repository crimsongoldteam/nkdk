...
export const ZFormattedDocumentField = z.object({
...
export const ZFormattedDocumentFieldXML = z.object({
  _name: z.string(),
  _id: z.string(),
...
export type TFormattedDocumentFieldXML = z.infer<
  typeof ZFormattedDocumentFieldXML
>;
