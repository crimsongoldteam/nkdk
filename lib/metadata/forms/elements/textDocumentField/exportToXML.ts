...
export const exportTextDocumentFieldToXML = (data: TextDocumentField | undefined): TextDocumentFieldXML | undefined => {
...
registerExport(FormElementType.TextDocumentField, exportTextDocumentFieldToXML)