...
const rules: TElementRules = {
  ...
  "beginOfRepresentationPeriod": {
    get type() { return z.string() },
    nameEnterprise: "НачалоПериодаОтображения",
    formatProperties: undefined,
    inProperties: ()=> true,
  },
  "border": {
  ...
  "calendarNavigation": {
    get type() { return z.boolean() },
    nameEnterprise: "ПеремещениеПоКалендарю",
    formatProperties: formatBoolean,
    inProperties: ()=> true,
  },
  "enableDrag": {
  ...
  "endOfRepresentationPeriod": {
    get type() { return z.string() },
    nameEnterprise: "КонецПериодаОтображения",
    formatProperties: undefined,
    inProperties: ()=> true,
  },
  "font": {
  ...
  "selectionMode": {
    get type() { return SE.ZDateSelectionMode },
    nameEnterprise: "РежимВыделения",
    formatProperties: formatSystemEnumeration,
    get typeEnterprise() { return SE.ZDateSelectionModeEnterprise },
    inProperties: ()=> true,
  },
  "showCurrentDate": {
    get type() { return z.boolean() },
    nameEnterprise: "ОтображатьТекущуюДату",
    formatProperties: formatBoolean,
    inProperties: ()=> true,
  },
  "showMonthsPanel": {
    get type() { return z.boolean() },
    nameEnterprise: "ОтображатьПанельМесяцев",
    formatProperties: formatBoolean,
    inProperties: ()=> true,
  },
  "verticalStretch": {
  ...
  "widthInMonths": {
    get type() { return z.number() },
    nameEnterprise: "ШиринаВМесяцах",
    formatProperties: undefined,
    inProperties: ()=> true,
  },
}

registerElementRules(ZElementType.enum.CalendarField, rules)