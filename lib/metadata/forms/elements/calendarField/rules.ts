...
export const ZCalendarFieldRules: TElementRules = {
  "autoCellHeight": {
  ...
  "beginOfRepresentationPeriod": {
    get type() { return z.string() },
    nameXML: "BeginOfRepresentationPeriod",
    get typeXML() { return z.string() },
  ...
  "endOfRepresentationPeriod": {
    get type() { return z.string() },
    nameXML: "EndOfRepresentationPeriod",
    get typeXML() { return z.string() },
  ...
  "selectionMode": {
    ...
    get typeXML() { return SE.ZDateSelectionMode },
