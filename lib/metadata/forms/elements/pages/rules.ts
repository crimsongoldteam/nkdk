...
export const ZPagesRules: TElementRules = {
  "enableContentChange": {
  ...
  "currentPagesState": {
    ...
    nameXML: "CurrentPagesState",
    get typeXML() { return SE.ZFormPagesState },
  ...
  "pagesRepresentation": {
    ...
    nameXML: "PagesRepresentation",
    get typeXML() { return SE.ZFormPagesRepresentation },
